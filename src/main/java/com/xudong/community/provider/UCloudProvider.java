...
/**
 * Created by xuxudong on 2020-03-20 16:23
 */
@Service
public class UCloudProvider {
    ...
    private String bucketName = "dodo";
    ...
    public String upload(InputStream fileStream, String mimeType, String fileName) {
        ...
        try {
            ...
            if (response != null && response.getRetCode() == 0) {
                String url = UfileClient.object(objectAuthorization, config).getDownloadUrlFromPrivateBucket(generateFileName,
                        bucketName, expiresDuration).createUrl();
                return url;
            } else {
